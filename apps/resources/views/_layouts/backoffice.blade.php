...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
        <img src="{{ asset('template/argon/assets/img/logo-ct-dark.png') }}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">Asset Apps</span>
      </a>
    </div>
    <hr class="horizontal dark mt-0">
    @include('../_navigations/backoffice')
  </aside>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">{{ ucfirst(Request::segment(1)) }}</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">{{ ucfirst(Request::segment(1)) }}</h6>
        </nav>
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="pr-4" style="padding-right:10px">
  ...
  <script src="{{ asset('template/argon/assets/js/plugins/chartjs.min.js') }}"></script>
  <script>
