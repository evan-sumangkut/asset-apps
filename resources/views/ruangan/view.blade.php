          ...
          <table class="table align-items-center mb-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$d->nama}}</td>
                <td>{{$d->keterangan}}</td>
                <td class="text-center">{{$d->jumlah_asset()}}</td>
                <td>
                  <a class="btn btn-xs btn-success" href="{{route('ruangan_qrcode',$d->id)}}"><i class="fa fa-qrcode"></i> QrCode</a>
                  <a href="{{ route('preview',$d->id) }}" class="btn btn-xs btn-info"><i class="fa fa-image"></i> Preview</a>
...
<div class="modal fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <form action="{{ route('ruangan_create') }}" method="post">
        @csrf
...
<div class="modal fade" id="modalHapus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <form action="{{ route('ruangan_delete') }}" method="post">
        @csrf
        @method('delete')
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <form action="{{ route('ruangan_update') }}" method="post">
        @csrf
        @method('PATCH')
